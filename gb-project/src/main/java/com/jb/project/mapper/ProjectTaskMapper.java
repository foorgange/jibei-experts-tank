...
public interface ProjectTaskMapper
{
    ...
    public void updateStatus3AndType1ById(@Param("userId") Long userId, @Param("projectId") Long projectId);
    ...
    public void updateStatus1AndType0ById(@Param("userId") Long userId, @Param("projectId") Long projectId);

    //修改任务状态从1(待审核)到2(已完成)
    public Long updateStatus1to2ById(Long projectId);
